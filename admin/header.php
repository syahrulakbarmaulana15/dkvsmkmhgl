			...
			<div class="container">
				...
				<ul class="nav-menu float-left">
					...
					<?php }elseif($_SESSION['ulevel'] == 'Admin'){ ?>
						...
						<li><a href="jurusan.php">Materi Pembelajaran</a></li>
						...
						<li>
							...
							<ul class="dropdown">
								...
								<li><a href="tentang-sekolah.php">Tentang Konsentrasi</a></li>
								<li><a href="kepala-sekolah.php">Kepala Konsentrasi Keahlian</a></li>
							</ul>
						</li>
