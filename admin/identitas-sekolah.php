					...
					<div class="box-body">
						...
						<form action="" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" name="instagram" placeholder="Instagram" value="<?= $d->instagram ?>" class="input-control" required>
							</div>

							<div class="form-group">
								<label>Youtube</label>
								<input type="text" name="youtube" placeholder="Youtube" value="<?= $d->youtube ?>" class="input-control" required>
							</div>

							<div class="form-group">
								<label>Tiktok</label>
								<input type="text" name="tiktok" placeholder="Tiktok" value="<?= $d->tiktok ?>" class="input-control" required>
							</div>
