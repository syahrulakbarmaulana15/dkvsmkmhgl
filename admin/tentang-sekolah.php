			...
			<div class="container">
				...
				<div class="box">
					...
					<div class="box-header">
						Tentang Konsentrasi Desain Komunikasi Visual
					</div>
					...
					<div class="box-body">
						...
						<form action="" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label>Tentang Konsentrasi Desain Komunikasi Visual</label>
								<textarea name="tentang" class="input-control" placeholder="Tentang Konsentrasi Desain Komunikasi Visual"></textarea>
							</div>
